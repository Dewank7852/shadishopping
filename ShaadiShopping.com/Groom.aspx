<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Groom.aspx.cs" Inherits="Groom" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Item_id"
      Height="162px" Width="214px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" AllowPaging="True" BackColor="#FFFF66" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" PageSize="5" style="z-index: 100; left: 0px; position: absolute; top: 0px" DataSourceID="SqlDataSource1" SelectedIndex="1">
        <Columns>
            <asp:TemplateField>
                <EditItemTemplate>
    ...
    <asp:Panel ID="Panel2" runat="server" Height="50px" Style="z-index: 101; left: 693px;
        position: absolute; top: 216px" Width="247px" BorderColor="#C00000" BorderStyle="Double">
        ...
        <asp:Label ID="Label2" runat="server" Style="z-index: 102; left: 24px; position: absolute;
            top: 19px" Text="Products" Font-Bold="True" Font-Italic="True" Font-Names="Estrangelo Edessa" ForeColor="Maroon"></asp:Label>
    </asp:Panel>
    &nbsp; &nbsp;
    <asp:Label ID="Label1" runat="server" Style="z-index: 102; left: 891px; position: absolute;
        top: -846px" Text="Products"></asp:Label>
    <asp:Panel ID="Panel1" runat="server" Height="296px" Style="z-index: 103; left: 593px;
        position: absolute; top: 281px" Width="352px" BorderColor="#C00000" BorderStyle="Double">
        ...
        <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Size="Medium" Style="z-index: 101;
            left: 127px; position: absolute; top: 2px" Text="Catalog Status" Font-Italic="True" Font-Names="Estrangelo Edessa" ForeColor="Green"></asp:Label>
        <br />
        <br />
        <br />
        <br />
    ...
    <asp:LinkButton ID="LinkButton1" runat="server" Font-Bold="True" Font-Italic="True"
        ...
        left: 869px; position: absolute; top: 11px">Sign out</asp:LinkButton>
    <br />
    <br />
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
    <asp:Image ID="groom1" runat="server" Height="552px" ImageUrl="~/images/groom1.jpg"
        Style="z-index: 105; left: 155px; position: absolute; top: 0px" Width="238px" />
    ...
    <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Style="z-index: 106;
        left: 839px; position: absolute; top: 665px" Text="Continue.." BorderColor="Green" BorderStyle="Dashed" />
    &nbsp; &nbsp; &nbsp; &nbsp;
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
    &nbsp; &nbsp;&nbsp;&nbsp;
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
